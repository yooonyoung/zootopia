...
// Source File Name:   AccountFormValidator.java
    ...
    implements Validator
{
    ...
    {
        return com/example/jpetstore/domain/Account.isAssignableFrom(clazz);
    }
    ...
    public void validate(Object obj, Errors errors)
    {
        ...
        if(account.getPassword() != null && account.getPassword().length() > 0 && !account.getPassword().equals(accountForm.getRepeatedPassword()))
