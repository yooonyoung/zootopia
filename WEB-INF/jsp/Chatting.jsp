...
<script type="text/javascript">
	window.zootopia = {};
	zootopia.chat = {};
	zootopia.chat.contextPath = '${pageContext.request.contextPath}';
	zootopia.chat.currentUser = {};
	zootopia.chat.currentUser.id = '${userId}';
	zootopia.chat.currentUser.name = '${userId}';
</script>
<!-- <script type="text/javascript"
...
<script type="text/javascript"
	...
	<div class="chat-main">
		<div class="container">
			<div class="row">
				<div class="col-md-9" style="margin-left:50px; max-width:50%; !important;">
