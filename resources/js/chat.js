...
(function($) {
	...
	$(document).ready(function() {
		updateUrl(zootopia.chat.contextPath + '/chat/chat-handler/websocket');
		connect();
	...
	function printMessage(message, userName) {
		...
		userName = userName ? userName : zootopia.chat.currentUser.name;
		primaryFont.text(userName);
		chatBodyHeader.append(primaryFont);
		textMuted.append(glyphiconTime).text(getTimeStamp());
